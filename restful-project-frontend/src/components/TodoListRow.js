  ...
  render() {
    return (
      <div className="todoRow">
        ...
        <input className="todoTitle d-inline" value={this.props.item.title} readonly id="title" for="flexCheckDefault"></input>
        <input value={this.props.item.id} hidden id="id" ></input>
